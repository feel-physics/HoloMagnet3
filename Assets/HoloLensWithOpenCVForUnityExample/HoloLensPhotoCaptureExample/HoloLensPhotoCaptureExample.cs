...
namespace HoloLensWithOpenCVForUnityExample
{
    ...
    public class HoloLensPhotoCaptureExample : MonoBehaviour
    {
        ...
        UnityEngine.Windows.WebCam.PhotoCapture m_PhotoCaptureObj;
        ...
        void Initialize()
        {
            ...
            m_CameraParameters = new WSAWebCamCameraParameters(UnityEngine.Windows.WebCam.WebCamMode.PhotoMode);
        ...
        void OnStopPhotoMode(UnityEngine.Windows.WebCam.PhotoCapture.PhotoCaptureResult result)
        {
