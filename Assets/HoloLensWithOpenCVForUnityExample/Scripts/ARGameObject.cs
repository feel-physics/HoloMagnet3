...
namespace HoloLensWithOpenCVForUnityExample
{
    ...
    public class ARGameObject : MonoBehaviour
    {
        ...
        private static float positionJumpThreshold = 0.3f;
        private static float rotationJumpThreshold = 90f;
        private static float positionRecoverThreshold = 0.04f;
        private static float rotationRecoverThreshold = 12f;
        private static int maxPendingList = 3;
        public List<Vector3> pendingPositionList = new List<Vector3>();
        public List<Quaternion> pendingRotationList = new List<Quaternion>();
